...
const cssSnippets = require('../').cssSnippets;
...
describe('CSS snippets', () => {
	...
	it('default value', () => {
		assert.equal(snippets.bg.defaultValue, '#${1:000}');
		assert.equal(snippets.bga.defaultValue, 'fixed');
		assert.equal(snippets.bgpy.defaultValue, null);
	});
});
